...
const SkeletonLoader = () => {
  ...
  const arr = new Array(20).fill("mrb");
  // ekrana 20 tane card iskeleti basıyoruz.
    ...
    <div key={key} className="animate-pulse">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="h-2.5 bg-gray-600 w-16 rounded-full my-3" />

          <div className="flex gap-2">
            <div className="h-2 bg-gray-600 w-24 rounded-full" />
