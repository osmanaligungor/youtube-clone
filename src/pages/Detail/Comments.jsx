    ...
    <div className="my-6">
      {isLoading ? (
        ...
        <>
          ...
          <input
            type="text"
            className="w-full bg-transparent border-b border-secondaryy p-2 outline-none mb-5"
            ...
            <div className="flex gap-2 sm:gap-3 items-start px-1 py-3 sm:py-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                {Number(i.replyCount) > 0 && (
                  <div className="flex w-fit items-center p-1 rounded-md gap-2 text-blue-500 hover:bg-secondaryy cursor-pointer">
